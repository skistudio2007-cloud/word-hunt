...
export const LevelCompleteModal: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] pointer-events-none rounded-full opacity-35 select-none z-0 anim-bg-pulse"
        style={{
          background: 'radial-gradient(circle, rgba(251,191,36,0.45) 0%, rgba(245,158,11,0.15) 45%, transparent 70%)',
