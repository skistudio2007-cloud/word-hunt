    ...
    <header className="w-full max-w-[440px] mx-auto px-4 py-2.5 flex items-center justify-between text-slate-900 select-none">
      ...
      <div className="flex items-center gap-2">
        <motion.button
          ...
          className={`relative px-3.5 py-2 rounded-2xl text-white font-black text-xs flex items-center gap-1.5 shadow-md transition-colors cursor-pointer ${
            hasPurchasedHint
        ...
        >
          {hasPurchasedHint ? (
            ...
            <>
              ...
              <span>Ad Hint</span>
              <span className="px-1 py-0.2 rounded bg-amber-400 text-slate-950 text-[9px] font-black leading-tight">
                AD
              </span>
            </>
          )}
